...
<html lang="en">
                        ...
                        <div class="modal-box">
                            ...
                            <form action="AgregarProducto" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="descripcion2" rows="4" class="w-full px-4 py-2 border rounded-md resize-none focus:outline-none focus:border-blue-500" placeholder="Ingrese la descripción" required></textarea>
                                </div>
    ...
    for (i = 1; i < tr.length; i++) {
        ...
        if (td) {
            // Solo filtrar por las columnas de ID y Descripción (índices 0 y 2)
            for (var j = 0; j < td.length; j++) {
                if (j === 0 || j === 2) { // ID y Descripción
