...
<html lang="en">
    ...
    <body>
        ...
        <form id="formularioContacto" action="envio.jsp" method="post" class="mt-5 mb-5">
            <div class="container mx-auto px-4 mt-10">
            ...
            <div class="container mx-auto px-4 mt-10">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="apellido" name="apellido" type="text" placeholder="Doe" required 
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea id="mensaje" name="mensaje" placeholder="Escriba su mensaje aquí" required 
