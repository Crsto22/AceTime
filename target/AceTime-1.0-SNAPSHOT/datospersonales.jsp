...
<div class="flex flex-col lg:flex-row justify-between gap-6 mx-5 sm:mx-2 md:mx-20 mt-12 mb-12">
    ...
    <div class="w-full lg:w-1/2 h-min bg-zinc-100 shadow-lg rounded-lg overflow-hidden p-6">
