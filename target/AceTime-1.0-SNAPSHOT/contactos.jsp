...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mx-auto px-4 mt-28">
            <h1 class="text-4xl font-bold text-center mt-20">Contáctenos</h1>
            <div class="bg-yellow-500 h-1 w-24 mx-auto rounded-full border border-yellow-500"></div>
            <p class="text-center text-lg mt-4">Bienvenido a nuestra relojería. Estamos aquí para ayudarlo.</p>
        </div>
        <div class="flex flex-wrap justify-center mt-10 bg-slate-50">
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-4">
                <div class="flex flex-col items-center justify-center p-4 h-full">
                    <i class="fi fi-rr-envelope text-4xl"></i>
                    <p class="text-2xl font-bold my-5">Correo electrónico</p>
                    <p class="text-sm mb-5">Envíenos un mensaje y le responderemos lo más pronto posible</p>
                    <a href="#" class="text-blue-700">Acetime@correo.com</a>
                </div>
            </div>
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-4">
                <div class="flex flex-col items-center justify-center p-4 h-full">
                    <i class="fi fi-rr-phone-call text-4xl"></i>
                    <p class="text-2xl font-bold mb-5">Teléfono</p>
                    <p class="text-sm mb-5">Llámenos para obtener más información sobre nuestros productos y servicios</p>
                    <p class="text-blue-700" >1-800-123-4567</p>
                </div>
            </div>
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-4">
                <div class="flex flex-col items-center justify-center p-4 h-full">
                    <i class="fi fi-rr-marker text-4xl"></i>
                    <p class="text-2xl font-bold mb-5">Oficina</p>
                    <p class="text-sm mb-5">Visítenos en nuestra ubicación física para ver nuestra amplia selección de relojes</p>
                    <p class="text-blue-700">Av. xxx Mz xxx</p>
                </div>
            </div>
        </div>
        <div class="container mx-auto px-4 mt-10">
            ...
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded  text-center" role="alert">
                <strong class="font-bold">¡Mensaje enviado correctamente!</strong>
            </div>
            <%
            } else {
            %>
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded  text-center" role="alert">
                <strong class="font-bold">Error al enviar el mensaje</strong>
            </div>
            <%
                    }
                }
        ...
        <form id="form" class="mt-5 mb-5">
            <div class="container mx-auto px-4 mt-10">
                <h2 class="text-2xl font-bold text-center">Envíenos un mensaje</h2>
                <p class="text-center text-lg mt-4">Complete el formulario y nos pondremos en contacto con usted</p>
            </div>
            <div class="container mx-auto px-4 mt-10">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        <label for="apellido" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            Apellido
                        </label>
                        <input type="text" name="apellido" id="apellido" placeholder="Doe" required
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label for="correo" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            Correo electrónico
                        </label>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label for="mensaje" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                            Mensaje
                        </label>
                        <textarea  name="mensaje" id="mensaje" placeholder="Escriba su mensaje aquí" required
                                  class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"></textarea>
                    </div>
                </div>
                <div class="flex justify-center">
                    <button type="submit" id="button" value="Send Email"
                            class="bg-yellow-700 text-white font-bold py-2 px-4 rounded border border-transparent hover:border-yellow-600 hover:bg-white hover:text-yellow-700 focus:outline-none focus:shadow-outline">
                        Enviar
                    </button>
                </div>
            </div>
    ...
    <script type="text/javascript">
        emailjs.init('IPiJCHlo_1ONMGPKh')
    </script>
...
<script>
    document.getElementById('form').addEventListener('submit', function(event) {
        ...
        const serviceID = 'service_mr6fy55'; 
        const templateID = 'template_cgzzq68';

        emailjs.sendForm(serviceID, templateID, this)
            .then(() => {
                btn.value = 'Send Email';
                window.location.href = 'contactos.jsp?success=true'; 
            }, (err) => {
                btn.value = 'Send Email';
